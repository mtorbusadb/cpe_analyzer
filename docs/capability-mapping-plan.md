...
- Next unlocked milestone: Milestone 4, Concept Extraction From Customer-Care and Diagnostics.
...
Run `planlock` to lock Milestone 4, or `autostep` if Milestone 4 is already approved for execution.
